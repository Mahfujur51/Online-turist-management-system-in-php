...
if(isset($_POST['submit1']))
{
	...
	$sql="INSERT INTO  tbl_inquery(fullname,email,mobile,subject,description) VALUES('$fullname','$email','$mobile','subject','description')";
				...
				<div class="container">
					...
					<form name="enquiry" method="post">
						...
						<p style="width: 350px;">
							...
							<b>Full name</b>  <input type="text" name="fullname" class="form-control" id="fullname" placeholder="Full Name" required="">
						</p>
						<p style="width: 350px;">
							<b>Email</b>  <input type="email" name="email" class="form-control" id="email" placeholder="Valid Email id" required="">
						</p>
						<p style="width: 350px;">
							<b>Mobile No</b>  <input type="text" name="mobile" class="form-control" id="mobileno" maxlength="11" placeholder="11 Digit mobile No" required="">
						</p>
						<p style="width: 350px;">
