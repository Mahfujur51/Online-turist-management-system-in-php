...
if(strlen($_SESSION['alogin'])==0)
{
	...
	if(isset($_POST['submit']))
	{
		...
		$upsql="UPDATE tbl_tourpackage SET  packageimage='$packageimage' where id='$id'";
		$upquery=mysqli_query($con,$upsql);
		if ($upquery) {
			$msg="Image Change Successfully!!!";
		}
		else{
			$error="Image not Change !!";
		}
	}
	?>
	<!DOCTYPE HTML>
								...
								<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
									...
									# code...
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<img src="../images/<?php echo htmlentities($results['packageimage']);?>" width="200">
											</div>
										</div>
