						...
						<div class="col-md-3 four-grid">
							...
							<div class="col-md-3 four-grid">
								<div class="four-agileinfo">
									...
									?>
										<h4><?php echo htmlentities($num1);?></h4>
							...
							<div class="col-md-3 four-grid">
								<div class="four-w3ls">
									...
									<div class="four-text">
										...
										<?php 
									$sql2="SELECT * FROM tbl_inquery";
									$query2=mysqli_query($con,$sql2);
									$num2=mysqli_num_rows($query2);

									?>

										<h4><?php echo htmlentities($num2);?></h4>
							...
							<div class="col-md-3 four-grid">
								<div class="four-wthree">
									...
									<?php 
									$sql3="SELECT * FROM tbl_tourpackage";
									...
									<div class="four-text">
										...
										<h4><?php echo htmlentities($num3);?></h4>
							...
							<div class="col-md-3 four-grid">
								<div class="four-w3ls">
									...
									?>
										...
										<h4><?php echo htmlentities($num4);?></h4>
