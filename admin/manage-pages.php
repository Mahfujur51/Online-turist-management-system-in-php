...
if(strlen($_SESSION['alogin'])==0)
	...
	if(isset($_POST['submit']))
	{
		...
		if ($upquery) {
			...
			$error="Pages data not updated something wrong!!";
		}
								...
								<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											...
											?>
											<textarea class="form-control" rows="5" cols="50" name="details" placeholder="Package Details" required><?php echo $result['details']; ?>
