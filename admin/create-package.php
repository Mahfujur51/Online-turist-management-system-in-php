...
if(strlen($_SESSION['alogin'])==0)
{
	...
	if(isset($_POST['submit']))
	{
		...
		$sql="INSERT INTO tbl_tourpackage(packagename,packagetype,packagelocation,pakageprice,packagefetures,packagedetails,packageimage) VALUES('$packagename','$packagetype','$packagelocation','$pakageprice','$packagefetures','$packagedetails','$packageimage')";
							...
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control1" name="pakageprice" id="pakageprice" placeholder=" Package Price is USD" required>
										</div>
									</div>
									<div class="form-group">
